...
public class Task<TResult> {
  ...
  /**
   * @deprecated Please use {@link com.tasks.bolts.TaskCompletionSource()} instead.
   */
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    com.tasks.bolts.TaskCompletionSource<TResult> tcs = new com.tasks.bolts.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final com.tasks.bolts.TaskCompletionSource<Void> tcs = new com.tasks.bolts.TaskCompletionSource<>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final com.tasks.bolts.TaskCompletionSource<TResult> tcs = new com.tasks.bolts.TaskCompletionSource<>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final com.tasks.bolts.TaskCompletionSource<Task<TResult>> firstCompleted = new com.tasks.bolts.TaskCompletionSource<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final com.tasks.bolts.TaskCompletionSource<Task<?>> firstCompleted = new com.tasks.bolts.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final com.tasks.bolts.TaskCompletionSource<Void> allFinished = new com.tasks.bolts.TaskCompletionSource<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final com.tasks.bolts.TaskCompletionSource<TContinuationResult> tcs = new com.tasks.bolts.TaskCompletionSource<>();
    synchronized (lock) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
      final com.tasks.bolts.TaskCompletionSource<TContinuationResult> tcs,
   ...
   * @deprecated Please use {@link com.tasks.bolts.TaskCompletionSource} instead.
   */
  public class TaskCompletionSource extends com.tasks.bolts.TaskCompletionSource<TResult> {
